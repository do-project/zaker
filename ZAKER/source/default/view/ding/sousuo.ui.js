...
var Label_sousuo=ui("Label_sousuo");
var alayout_sousuo=ui("ALayout_sousuo");
alayout_sousuo.on("touchDown",function(data, e){
	Label_sousuo.fontColor = "808080FF";
});
alayout_sousuo.on("touch",function(data, e){
	Label_sousuo.fontColor = "000000FF";
});